...
class Rsg extends _i1.GeneratedContract {
  Rsg(
  ...
  Future<_i1.EthereumAddress> addressTax1({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[1];
    assert(checkSignature(function, 'a78f9549'));
    final params = [];
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i1.EthereumAddress> addressTax2({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[2];
    assert(checkSignature(function, '4f4e07b9'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as _i1.EthereumAddress);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> burnt({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[6];
    assert(checkSignature(function, 'b192da2d'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> deflation({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[8];
    assert(checkSignature(function, 'a337f621'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> initialSupply({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[9];
    assert(checkSignature(function, '378dc3dc'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> minSupply({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[10];
    assert(checkSignature(function, '8fe6cae3'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> tax1({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[13];
    assert(checkSignature(function, 'a5d4310e'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> tax2({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[14];
    assert(checkSignature(function, '28ea1539'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> totalTax1({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[16];
    assert(checkSignature(function, '546f85b1'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> totalTax2({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[17];
    assert(checkSignature(function, 'bf7fcc7a'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
